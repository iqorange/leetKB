package GUISort.mergeSort;

import java.awt.*;
import java.util.Arrays;

public class MSortVisualizer {

    private static int DELAY = 40;

    private MergeSortData data;
    private MSortFrame frame;

    public MSortVisualizer(int sceneWidth, int sceneHeight, int N){
        ...
        EventQueue.invokeLater(() -> {
            frame = new MSortFrame("Merge Sort Visualization", sceneWidth, sceneHeight);
    ...
    public static void main(String[] args) {
        ...
        MSortVisualizer vis = new MSortVisualizer(sceneWidth, sceneHeight, N);
    }
}