...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 绑定到本地端口上
        // backlog：允许等待的连接队列，超过连接数量将在客户端触发异常
...
//         serverSocket = new ServerSocket(PORT, 50, Inet4Address.getLocalHost());
    ...
    private static void initServerSocket(ServerSocket serverSocket) throws IOException {
        ...
        // 等效Socket#setReceiveBufferSize，（客户端的Size）上面拿到再设置则无效
        serverSocket.setReceiveBufferSize(64 * 1024 * 1024);

        // 设置serverSocket#accept超时时间，不设置默认永久等待
//         serverSocket.setSoTimeout(2000);

        // 设置性能参数：短链接，延迟，带宽的相对重要性，等效上面的拿到客户端直接设置
